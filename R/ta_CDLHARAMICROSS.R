...
#' @templateVar .title Harami Cross Pattern
...
CDLHARAMICROSS_lookback <- haramiCross_lookback <- harami_cross_lookback <- function(
	...
	.Call(
		C_impl_ta_CDLHARAMICROSS_lookback
	)
}
