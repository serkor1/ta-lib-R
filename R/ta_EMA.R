...
exponential_moving_average <- function(
	...
	UseMethod("exponential_moving_average")
}
...
#'
#' @export
exponential_moving_average.default <- function(
	x,
	cols,
	timePeriod = 30,
	na.bridge = FALSE,
...
#'
#' @export
exponential_moving_average.data.frame <- function(
	x,
	cols,
	timePeriod = 30,
	na.bridge = FALSE,
	...
	map_dfr(
		exponential_moving_average.default(
			x = x,
			cols = cols,
...
#'
#' @export
exponential_moving_average.matrix <- function(
	x,
	cols,
	timePeriod = 30,
	na.bridge = FALSE,
...
#'
#' @export
exponential_moving_average.numeric <- function(
	x,
	cols,
	timePeriod = 30,
	na.bridge = FALSE,
...
exponential_moving_average.plotly <- function(
	...
	## construct indicator
	## from the series
	constructed_indicator <- exponential_moving_average(
	...
	plotly_object <- build_plotly(
		...
		traces = list(
			list(
				y = ~constructed_indicator[["EMA"]][-(1:attr(constructed_indicator, "lookback", TRUE))],
...
#'
#' @export
exponential_moving_average.ggplot <- function(
	x,
	cols,
	timePeriod = 30,
	na.bridge = FALSE,
