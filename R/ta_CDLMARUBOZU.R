...
#' @usage NULL
CDLMARUBOZU_lookback <- marubozu_lookback <- function(
	x,
	cols,
	na.bridge = FALSE,
	...
	...
	.Call(
		C_impl_ta_CDLMARUBOZU_lookback
	)
}
...
marubozu.plotly <- function(
	...
	## construct indicator
	## from the series
	constructed_indicator <- marubozu(
