...
#' @templateVar .title Engulfing Pattern
...
#' @usage NULL
CDLENGULFING_lookback <- engulfing_lookback <- function(
	x,
	cols,
	na.bridge = FALSE,
	...
	...
	.Call(
		C_impl_ta_CDLENGULFING_lookback
	)
}
...
engulfing.plotly <- function(
	...
	## construct indicator
	## from the series
	constructed_indicator <- engulfing(
