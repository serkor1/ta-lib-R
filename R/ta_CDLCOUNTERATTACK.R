...
CDLCOUNTERATTACK_lookback <- counterAttack_lookback <- counter_attack_lookback <- function(
	...
	.Call(
		C_impl_ta_CDLCOUNTERATTACK_lookback
	)
}
...
counter_attack.plotly <- function(
	...
	## construct indicator
	## from the series
	constructed_indicator <- counter_attack(
...
#'
#' @export
counter_attack.ggplot <- function(
	x,
	cols,
	na.bridge = FALSE,
	...
