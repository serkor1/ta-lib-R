...
//
// Source
//      https://github.com/TA-Lib/ta-lib/blob/main/src/ta_func/ta_CDLTAKURI.c
//
...
// clang-format off
SEXP impl_ta_CDLTAKURI_lookback(
    SEXP inOpen,
    SEXP inHigh,
    SEXP inLow,
    SEXP inClose
...
// clang-format on
{
  ...
  // calculate lookback
  const int lookback = TA_CDLTAKURI_Lookback();
...
// clang-format on
{
  ...
  if (proceed) {
    ...
    // TA_CDLTAKURI returns an TA_RetCode
  ...
  // ta_CDLTAKURI returns values in the range [-200, 200]
