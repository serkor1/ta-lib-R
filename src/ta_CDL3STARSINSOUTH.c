// Interface to TA_CDL3STARSINSOUTH (Three Stars In The South)
//
// Parameters
...
//
// Description
//   Identifies Three Stars In The South patterns. Returns an integer vector of
...
SEXP impl_ta_CDL3STARSINSOUTH(
  ...
  const int minimum_lookback = TA_CDL3STARSINSOUTH_Lookback();
  ...
  if (n < minimum_lookback) {
    ...
    if (rc != TA_SUCCESS) {
      ...
      Rf_error("TA_CDL3STARSINSOUTH failed: return code %d", rc);
    }
