...
// clang-format off
SEXP impl_ta_MIDPRICE_lookback(
	SEXP inHigh,
	SEXP inLow,
...
// clang-format on
{
  ...
  // calculate lookback
  const int lookback = TA_MIDPRICE_Lookback(optInTimePeriod_value);
