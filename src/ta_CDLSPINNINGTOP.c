...
//
// Source
//      https://github.com/TA-Lib/ta-lib/blob/main/src/ta_func/ta_CDLSPINNINGTOP.c
//
...
// clang-format off
SEXP impl_ta_CDLSPINNINGTOP_lookback(
    SEXP inOpen,
    SEXP inHigh,
    SEXP inLow,
    SEXP inClose
...
// clang-format on
{
  ...
  // calculate lookback
  const int lookback = TA_CDLSPINNINGTOP_Lookback();
...
// clang-format on
{
  ...
  if (proceed) {
    ...
    // TA_CDLSPINNINGTOP returns an TA_RetCode
  ...
  set_colnames(output, "CDLSPINNINGTOP");
  ...
  // ta_CDLSPINNINGTOP returns values in the range [-200, 200]
