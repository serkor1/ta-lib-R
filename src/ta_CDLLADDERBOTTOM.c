...
//
// Source
//      https://github.com/TA-Lib/ta-lib/blob/main/src/ta_func/ta_CDLLADDERBOTTOM.c
//
#include "MAType.h"
...
// clang-format off
SEXP impl_ta_CDLLADDERBOTTOM_lookback(
	SEXP inOpen,
	SEXP inHigh,
	SEXP inLow,
	SEXP inClose
...
// clang-format on
{
  ...
  // calculate lookback
  const int lookback = TA_CDLLADDERBOTTOM_Lookback();
...
// clang-format on
{
  ...
  if (proceed) {
    ...
    // TA_CDLLADDERBOTTOM returns an TA_RetCode
  ...
  set_colnames(output, "CDLLADDERBOTTOM");
  ...
  // ta_CDLLADDERBOTTOM returns values in the range [-200, 200]
