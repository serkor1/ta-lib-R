// interface to ta_CDLEVENINGDOJISTAR.c
//
// Parameters
// 		double  inOpen
// 		double  inHigh
...
//
// Source
//      https://github.com/TA-Lib/ta-lib/blob/main/src/ta_func/ta_CDLEVENINGDOJISTAR.c
//
#include "MAType.h"
...
// clang-format off
SEXP impl_ta_CDLEVENINGDOJISTAR_lookback(
	SEXP inOpen,
	SEXP inHigh,
	SEXP inLow,
	SEXP inClose,
...
// clang-format on
{
  ...
  // calculate lookback
  const int lookback = TA_CDLEVENINGDOJISTAR_Lookback(optInPenetration_value);
...
// clang-format on
{
  ...
  if (proceed) {
    ...
    // TA_CDLEVENINGDOJISTAR returns an TA_RetCode
  ...
  set_colnames(output, "CDLEVENINGDOJISTAR");
  ...
  // ta_CDLEVENINGDOJISTAR returns values in the range [-200, 200]
