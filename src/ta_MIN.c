...
//
// Source
//      https://github.com/TA-Lib/ta-lib/blob/main/src/ta_func/ta_MIN.c
//
#include "MAType.h"
...
// clang-format on
{
  ...
  // calculate lookback
  const int lookback = TA_MIN_Lookback(optInTimePeriod_value);
