...
//
// Description
// Identifies Long Line Candle pattern.
...
//
// Returns
// Integer vector length n. Long Line is neutral/agnostic.
...
SEXP impl_ta_CDLLONGLINE(
  ...
  const int minimum_lookback = TA_CDLLONGLINE_Lookback();
  ...
  if (n < minimum_lookback) {
    ...
    if (return_code != TA_SUCCESS) {
      ...
      Rf_error("TA_CDLLONGLINE failed: %d", return_code);
    }
