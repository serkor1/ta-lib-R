...
//
// Source
//      https://github.com/TA-Lib/ta-lib/blob/main/src/ta_func/ta_WILLR.c
//
#include "MAType.h"
...
// clang-format on
{
  ...
  // calculate lookback
  const int lookback = TA_WILLR_Lookback(optInTimePeriod_value);
...
// clang-format on
{
  ...
  if (proceed) {
    ...
    // TA_WILLR returns an TA_RetCode
