...
// clang-format on
{
  ...
  // calculate lookback
  const int lookback = TA_CDLDOJI_Lookback();
...
// clang-format on
{
  ...
  if (proceed) {
    ...
    // TA_CDLDOJI returns an TA_RetCode
  ...
  // ta_CDLDOJI returns values in the range [-200, 200]
