// interface to ta_CDL3BLACKCROWS.c
//
// Parameters
//      double  inOpen
//      double  inClose
...
//
// Source
//      https://github.com/TA-Lib/ta-lib/blob/main/src/ta_func/ta_CDL3BLACKCROWS.c
//
...
// clang-format off
SEXP impl_ta_CDL3BLACKCROWS_lookback(
    SEXP inOpen,
    SEXP inHigh,
    SEXP inLow,
    SEXP inClose
...
// clang-format on
{
  ...
  // calculate lookback
  const int lookback = TA_CDL3BLACKCROWS_Lookback();
...
// clang-format on
{
  ...
  if (proceed) {
    ...
    // TA_CDL3BLACKCROWS returns an TA_RetCode
  ...
  set_colnames(output, "CDL3BLACKCROWS");
  ...
  // ta_CDL3BLACKCROWS returns values in the range [-200, 200]
