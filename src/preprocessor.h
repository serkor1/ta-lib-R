// preprocessor.h
//
// Generic preprocessor metaprogramming primitives
// (token paste, arg count, list map/join) used to
// drive the TA_WRAPPER X-macros.
...
// Strip parenthesis from an expression -
