...
//
// Source
//      https://github.com/TA-Lib/ta-lib/blob/main/src/ta_func/ta_HT_DCPHASE.c
//
#include "MAType.h"
...
// clang-format off
SEXP impl_ta_HT_DCPHASE_lookback(
	SEXP inReal
)
// clang-format on
{
...
// clang-format on
{
  ...
  set_colnames(output, "HT_DCPHASE");
