// Interface to TA_CDL3OUTSIDE (Three Outside Up/Down)
//
// Parameters
...
//
// Description
//   Identifies Three Outside Up/Down patterns. Returns an integer vector of
...
SEXP impl_ta_CDL3OUTSIDE(
  ...
  const int minimum_lookback = TA_CDL3OUTSIDE_Lookback();
  ...
  if (n < minimum_lookback) {
    ...
    if (rc != TA_SUCCESS) {
      ...
      Rf_error("TA_CDL3OUTSIDE failed: return code %d", rc);
    }
