...
//
// Source
//      https://github.com/TA-Lib/ta-lib/blob/main/src/ta_func/ta_MOM.c
//
#include "MAType.h"
...
// clang-format on
{
  ...
  // calculate lookback
  const int lookback = TA_MOM_Lookback(optInTimePeriod_value);
