...
//
// Source
//      https://github.com/TA-Lib/ta-lib/blob/main/src/ta_func/ta_CDLSEPARATINGLINES.c
//
...
// clang-format off
SEXP impl_ta_CDLSEPARATINGLINES_lookback(
    SEXP inOpen,
    SEXP inHigh,
    SEXP inLow,
    SEXP inClose
...
// clang-format on
{
  ...
  // calculate lookback
  const int lookback = TA_CDLSEPARATINGLINES_Lookback();
...
// clang-format off
SEXP impl_ta_CDLSEPARATINGLINES(
    SEXP inOpen,
    SEXP inHigh,
    SEXP inLow,
    SEXP inClose,
...
// clang-format on
{
  ...
  if (proceed) {
    ...
    // TA_CDLSEPARATINGLINES returns an TA_RetCode
  ...
  set_colnames(output, "CDLSEPARATINGLINES");
  ...
  // ta_CDLSEPARATINGLINES returns values in the range [-200, 200]
