...
//
// Description
//   Identifies the "Doji Star" candlestick pattern, which is a two-day pattern where a Doji candle appears after a long candle (gap-up or gap-down).
//   Returns an integer vector of the same length, with +100 indicating a bullish Doji Star pattern and -100 indicating a bearish Doji Star (0 if no pattern). 
