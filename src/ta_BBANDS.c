...
SEXP impl_ta_BBANDS(SEXP inReal, SEXP optTimePeriod,
                    SEXP optNbDevUp, SEXP optNbDevDn, SEXP optMAType)
{
    ...
    int outBeg, outNb;
    TA_RetCode ret = TA_BBANDS(0, n-1, src,
                               period, nbUp, nbDn, maType,
                               &outBeg, &outNb,
                               upper + outBeg,
                               middle + outBeg,
                               lower + outBeg);
