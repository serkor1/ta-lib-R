...
//
// Returns
// Integer vector length n. Long-Legged Doji is neutral/agnostic.
...
SEXP impl_ta_CDLLONGLEGGEDDOJI(
  ...
  const int minimum_lookback = TA_CDLLONGLEGGEDDOJI_Lookback();
  ...
  if (n < minimum_lookback) {
    ...
    if (return_code != TA_SUCCESS) {
      ...
      Rf_error("TA_CDLLONGLEGGEDDOJI failed: %d", return_code);
    }
