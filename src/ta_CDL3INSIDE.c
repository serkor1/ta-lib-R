...
//
// Source
//      https://github.com/TA-Lib/ta-lib/blob/main/src/ta_func/ta_CDL3INSIDE.c
//
#include "MAType.h"
...
// clang-format off
SEXP impl_ta_CDL3INSIDE_lookback(
	SEXP inOpen,
	SEXP inHigh,
	SEXP inLow,
	SEXP inClose
...
// clang-format on
{
  ...
  // calculate lookback
  const int lookback = TA_CDL3INSIDE_Lookback();
...
// clang-format on
{
  ...
  if (proceed) {
    ...
    // TA_CDL3INSIDE returns an TA_RetCode
  ...
  // ta_CDL3INSIDE returns values in the range [-200, 200]
