// interface to ta_CDLIDENTICAL3CROWS.c
//
// Parameters
//      double  inOpen
//      double  inClose
...
//
// Source
//      https://github.com/TA-Lib/ta-lib/blob/main/src/ta_func/ta_CDLIDENTICAL3CROWS.c
//
...
// clang-format off
SEXP impl_ta_CDLIDENTICAL3CROWS_lookback(
    SEXP inOpen,
    SEXP inHigh,
    SEXP inLow,
    SEXP inClose
...
// clang-format on
{
  ...
  // calculate lookback
  const int lookback = TA_CDLIDENTICAL3CROWS_Lookback();
...
// clang-format on
{
  ...
  if (proceed) {
    ...
    // TA_CDLIDENTICAL3CROWS returns an TA_RetCode
  ...
  // ta_CDLIDENTICAL3CROWS returns values in the range [-200, 200]
