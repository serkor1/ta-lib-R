...
//
// Description
//   R wrapper for TA-Lib's CDL Identical Three Crows pattern detector.
...
//   -100 when Identical Three Crows occurs, 0 otherwise. Bearish pattern.
...
SEXP impl_ta_CDLIDENTICAL3CROWS(
  ...
  if (n < minimum_lookback) {
    ...
    if (return_code != TA_SUCCESS) {
      ...
      Rf_error("TA_CDLIDENTICAL3CROWS failed: return code %d", return_code);
    }
