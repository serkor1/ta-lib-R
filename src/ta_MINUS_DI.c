...
//
// Source
//      https://github.com/TA-Lib/ta-lib/blob/main/src/ta_func/ta_MINUS_DI.c
//
#include "MAType.h"
...
// clang-format off
SEXP impl_ta_MINUS_DI_lookback(
	SEXP inHigh,
	SEXP inLow,
	SEXP inClose,
...
// clang-format on
{
  ...
  // calculate lookback
  const int lookback = TA_MINUS_DI_Lookback(optInTimePeriod_value);
...
// clang-format on
{
  ...
  if (proceed) {
    ...
    // TA_MINUS_DI returns an TA_RetCode
