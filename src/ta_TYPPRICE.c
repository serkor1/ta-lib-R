...
//
// Source
//      https://github.com/TA-Lib/ta-lib/blob/main/src/ta_func/ta_TYPPRICE.c
//
#include "MAType.h"
...
// clang-format off
SEXP impl_ta_TYPPRICE_lookback(
	SEXP inHigh,
	SEXP inLow,
	SEXP inClose
)
// clang-format on
{
  ...
  // calculate lookback
  const int lookback = TA_TYPPRICE_Lookback();
