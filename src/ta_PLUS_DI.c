...
//
// Source
//      https://github.com/TA-Lib/ta-lib/blob/main/src/ta_func/ta_PLUS_DI.c
//
#include "MAType.h"
...
// clang-format on
{
  ...
  // calculate lookback
  const int lookback = TA_PLUS_DI_Lookback(optInTimePeriod_value);
...
// clang-format on
{
  ...
  if (proceed) {
    ...
    // TA_PLUS_DI returns an TA_RetCode
