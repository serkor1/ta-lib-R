...
//
// Source
//      https://github.com/TA-Lib/ta-lib/blob/main/src/ta_func/ta_CDL2CROWS.c
//
...
// clang-format off
SEXP impl_ta_CDL2CROWS_lookback(
    SEXP inOpen,
    SEXP inHigh,
    SEXP inLow,
    SEXP inClose
...
// clang-format on
{
  ...
  // calculate lookback
  const int lookback = TA_CDL2CROWS_Lookback();
...
// clang-format on
{
  ...
  if (proceed) {
    ...
    // TA_CDL2CROWS returns an TA_RetCode
  ...
  // ta_CDL2CROWS returns values in the range [-200, 200]
