...
// clang-format off
SEXP impl_ta_CDLDARKCLOUDCOVER_lookback(
	SEXP inOpen,
	SEXP inHigh,
	SEXP inLow,
	SEXP inClose,
...
// clang-format on
{
  ...
  // calculate lookback
  const int lookback = TA_CDLDARKCLOUDCOVER_Lookback(optInPenetration_value);
...
// clang-format on
{
  ...
  // ta_CDLDARKCLOUDCOVER returns values in the range [-200, 200]
