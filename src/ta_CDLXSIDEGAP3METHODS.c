...
//
// Source
//      https://github.com/TA-Lib/ta-lib/blob/main/src/ta_func/ta_CDLXSIDEGAP3METHODS.c
//
...
// clang-format off
SEXP impl_ta_CDLXSIDEGAP3METHODS_lookback(
    SEXP inOpen,
    SEXP inHigh,
    SEXP inLow,
    SEXP inClose
...
// clang-format on
{
  ...
  // calculate lookback
  const int lookback = TA_CDLXSIDEGAP3METHODS_Lookback();
...
// clang-format on
{
  ...
  if (proceed) {
    ...
    // TA_CDLXSIDEGAP3METHODS returns an TA_RetCode
  ...
  set_colnames(output, "CDLXSIDEGAP3METHODS");
  ...
  // ta_CDLXSIDEGAP3METHODS returns values in the range [-200, 200]
