...
`r generate_returns_section(rolling_beta(talib::BTC))`
...
## for Bitcoin (BTC)
output <- talib::rolling_beta(BTC)
#> Error in rolling_beta.default(BTC): 'list' object cannot be coerced to type 'double'
