...
`r generate_returns_section(rolling_min(talib::BTC))`
...
## for Bitcoin (BTC)
output <- talib::rolling_min(BTC)
#> Error in rolling_min.default(BTC): 'list' object cannot be coerced to type 'double'
