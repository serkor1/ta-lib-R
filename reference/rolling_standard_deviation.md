...
`r generate_returns_section(rolling_standard_deviation(talib::BTC))`
...
## for Bitcoin (BTC)
output <- talib::rolling_standard_deviation(BTC)
#> Error in rolling_standard_deviation.default(BTC): 'list' object cannot be coerced to type 'double'
