...
- y:
  ...
  A price series ([double](https://rdrr.io/r/base/double.html))
...
`r generate_returns_section(rolling_correlation(talib::BTC))`
...
## for Bitcoin (BTC)
output <- talib::rolling_correlation(BTC)
#> Error in rolling_correlation.default(BTC): 'list' object cannot be coerced to type 'double'
