...
`r generate_returns_section(rolling_max(talib::BTC))`
...
## for Bitcoin (BTC)
output <- talib::rolling_max(BTC)
#> Error in rolling_max.default(BTC): 'list' object cannot be coerced to type 'double'
