...
`average_deviation()` is a generic S3 function that preserves the input
...
`average_deviation()` also accepts a
...
``` r
average_deviation(x, cols, timePeriod = 14, na.bridge = FALSE, ...)
```
...
- cols:
  ...
  consumed in formula order. Defaults to `~close`.
...
## for Bitcoin (BTC)
output <- talib::average_deviation(BTC)

## display the results
utils::tail(output)
#>                       AVGDEV
#> 2024-12-26 01:00:00 3084.541
#> 2024-12-27 01:00:00 3231.804
#> 2024-12-28 01:00:00 3232.707
#> 2024-12-29 01:00:00 2951.729
#> 2024-12-30 01:00:00 2543.020
#> 2024-12-31 01:00:00 2013.994
```
