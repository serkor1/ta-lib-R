...
`r generate_returns_section(rolling_variance(talib::BTC))`
...
## for Bitcoin (BTC)
output <- talib::rolling_variance(BTC)
#> Error in rolling_variance.default(BTC): 'list' object cannot be coerced to type 'double'
