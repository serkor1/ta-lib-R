...
[{talib}](https://serkor1.github.io/ta-lib-R/) can be installed via [{pak}](https://github.com/r-lib/pak) on Windows, MacOS and Linux. 

```{r devel_install, echo = TRUE, eval = FALSE}
pak::pak("serkor1/talib")
```

When installing via [{pak}](https://github.com/r-lib/pak) the configure scripts will handle the vendoring.
