...
This outlines how to propose a change to {talib}. For a detailed
...
> \[!NOTE\]
>
> New indicators should be proposed
> [upstream](https://github.com/TA-Lib/ta-lib).

### Pull request process

- Fork the package and clone onto your computer. If you haven’t done
  this before, we recommend using
  `usethis::create_from_github("serkor1/ta-lib-R", fork = TRUE)`.
...
Please note that the {talib} project is released with a [Contributor
Code of Conduct](https://serkor1.github.io/ta-lib-R/CODE_OF_CONDUCT.md).
