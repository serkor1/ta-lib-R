...
testthat::test_that(desc = 'Multivariate input errors', code = {
	...
	testthat::expect_error(rolling_sum(x = GOOGL))
	testthat::expect_error(rolling_sum(x = SPY))
})
