...
testthat::test_that(desc = 'Class in, class out (<matrix>)', code = {
	...
	testthat::expect_true(
		inherits(extended_moving_average_convergence_divergence(SPY), class(SPY))
	)
...
testthat::test_that(desc = 'Class in, class out (<data.frame>)', code = {
	...
	##    matches the input class
	testthat::expect_true(
		inherits(extended_moving_average_convergence_divergence(BTC), class(BTC))
	)
})
...
testthat::test_that(desc = 'Row names are respected for <data.frame>, na.bridge = TRUE', code = {
	...
	## calculate indicator
	indicator <- extended_moving_average_convergence_divergence(ATOM, na.bridge = TRUE)
...
testthat::test_that(desc = 'Row names are respected for <data.frame>', code = {
	...
	## calculate indicator
	indicator <- extended_moving_average_convergence_divergence(BTC)
...
testthat::test_that(desc = 'Row names are respected for <matrix>', code = {
	...
	## calculate indicator
	indicator <- extended_moving_average_convergence_divergence(SPY)
...
output <- attr(
	extended_moving_average_convergence_divergence(x = SPY),
	"lookback"
)

testthat::expect_equal(
		object = output,
		expected = lookback(FUN = extended_moving_average_convergence_divergence, x = SPY)
	)
...
testthat::test_that(desc = '<plotly>-methods for <data.frame>', code = {
	## check that extended_moving_average_convergence_divergence can
