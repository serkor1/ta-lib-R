...
testthat::test_that(desc = 'Multivariate input errors', code = {
	...
	testthat::expect_error(rolling_beta(x = GOOGL, y = GOOGL[, 2]))
	testthat::expect_error(rolling_beta(x = SPY, y = SPY[, 2]))
})
