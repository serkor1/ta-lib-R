...
testthat::test_that(desc = 'Multivariate input errors', code = {
	...
	testthat::expect_error(rolling_standard_deviation(x = GOOGL))
	testthat::expect_error(rolling_standard_deviation(x = SPY))
})
