...
testthat::test_that(desc = '<double> methods', code = {
	...
	##    function returns the same values
	output <- KAMA(SPY[, 1])
	alias <- kaufman_adaptive_moving_average(SPY[, 1])
